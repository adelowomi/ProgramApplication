...
public class StandardResponse<T> 
{
    ...
    {
        return new StandardResponse<T>(true, "Successful", data, HttpStatusCode.OK);
    }
    ...
    {
        return new StandardResponse<T>(true, "Successful", default(T), HttpStatusCode.OK);
    }
    ...
    {
        return new StandardResponse<T>(false, "Failed", default(T), HttpStatusCode.InternalServerError);
    }
